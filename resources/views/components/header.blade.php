...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        ...
        <select name="TahunSession" class="form-control" id="TahunSession">
            @for ($i = 2020; $i < 2031; $i++)
                <option {{ session('tahunSession')==$i ? 'selected':'' }} value="{{ $i }}">{{ $i }}</option>
            @endfor
        </select>
    </form>
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a
                    class="dropdown-item has-icon text-danger" href="{{ route('logout') }}"
