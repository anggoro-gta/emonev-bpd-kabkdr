    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <a href="{{ route('master.skpd.create') }}" class="btn btn-success" title="Tambah User"><i class="fas fa-plus"></i></a>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('setting.user.destroy')
                                                    <a data-url="{{ route('master.skpd.destroy',$item->id) }}" title="Hapus"
                            ...
                            <div class="card-footer text-right">
                                {{ $data->skpd->appends(['q' => old('q')])->links('vendor.pagination.bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
